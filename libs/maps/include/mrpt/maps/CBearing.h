...
class CBearing : public mrpt::poses::CPose3DPDF
{
   ...
   public:
	 ...
	 */
    mrpt::poses::CPose3DPDFParticles m_locationMC{1};
    ...
    mrpt::poses::CPose3DPDFGaussian m_locationGauss;
	 ...
	 * \sa getCovariance
	 */
    void getMean(mrpt::poses::CPose3D& mean_point) const override;
	...
	void getCovarianceAndMean(
        ...
        mrpt::poses::CPose3D& mean_point) const override;

	/** Copy operator, translating if necesary (for example, between particles
	 * and gaussian representations) */
    void copyFrom(const mrpt::poses::CPose3DPDF& o) override;
    ...
    void drawSingleSample(mrpt::poses::CPose3D& outSample) const override;
	 ...
	 */
	void bayesianFusion(
        const CPose3DPDF& p1, const CPose3DPDF& p2) override;
